...
geno_df.to_csv("test-data/genotypes.tsv", sep="\t")
...
sample_df.to_csv("test-data/phenotypes_covariates.tsv", sep="\t", index=False)
...
snp_annot.to_csv("test-data/snp_annotation.tsv", sep="\t", index=False)

print("Generated data in ./test-data directory")